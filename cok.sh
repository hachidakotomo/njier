...
echo "\033[32;1mAuthor : Mr CrOopPer-yuuki himaru"
echo "\033[37;1mFeat: all team icp"
echo "\033[35;1mversion Tools: new"
echo "\033[35;1mTeam : INDONESIAN CYBER PROJECT"
echo "\033[33;1mKontak Me : ICP GROUP"
echo "\033[31;1mall SAVE VVIBU"
echo "\033[92;1m --{DEMANSION}--" 
echo "\033[36;1mIndonesian cyber project tools"
echo "\033[34;1m[$]\033[36;1m============================\033[34;1m[$]"
echo ""
...
echo "[===============================================]>"
echo $purple "2.> Spam Sms Telkampret"
echo "[===============================================]>"
...
echo "[+]===============================================[+]"
echo "\033[32;1m"
read -p "root@T00Ls-Mr CrOopPer~#" bro
if [ $bro = 1 ] || [ $bro = 1 ]
then
clear
figlet "Mr CrOopPer" | lolcat
php tp.php
fi
...
then
clear
toilet -f slant --gay "Mr CrOopPer"
php kfc.php
fi
...
then
clear
toilet -f mono12 -F gay "Mr CrOopPer"
php phd.php
fi
...
then
clear
toilet -f slant -F gay "Mr CrOopPer"
...
then
clear
toilet -f standard -F gay "Mr CrOopPer"
...
clear
echo "\033[34;1m"
cowsay -f kiss.cow "Mr CrOopPer" | lolcat
...
then
clear
cowsay -f sheep.cow "Mr CrOopPer" | lolcat
figlet "Mr CrOopPer" | lolcat
sleep 1
cd
cd module
...
echo "\033[32;1mauthor: Mr.CrOopPer"
echo "\033[33;1mTeam: indonesian cyber project"
...
then
clear
cowsay -f kiss.cow "CrOopPer" | lolcat
figlet "Mr CrOopPer" | lolcat
sleep 1
apt update && apt upgrade
apt install pip
...
clear
echo "\033[31;1m"
cowsay ghostbusters.cow "Mr CrOopPer"
figlet "Mr CrOopPer" | lolcat
apt update && apt upgrade
apt install python2
apt install python
...
then
clear
toilet -f big -F gay "Mr CrOopPer " | lolcat
sleep 1
...
then
clear
toilet -f big -F gay " Mr CrOopPer"
sleep 1
apt update && apt upgrade
apt install wget
mkdir ngrok
...
then
clear
toilet -f big -F gay "Mr Mr CrOopPer"
sleep 1
apt update
apt upgrade
apt install git
